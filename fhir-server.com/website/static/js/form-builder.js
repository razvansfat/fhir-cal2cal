    ...
    !(function (e) {
        ...
        function (t, r, n) {
            ...
            var l = function (e) {
                ...
                c = function (e, t) {
                    var r;
                    return (e = p(e)), t && (Array.isArray(t) ? (r = k(t.join(" "))) : ("boolean" == typeof t && (t = t.toString()), (r = k(t.trim())))), { name: e, value: (t = t ? '="' + r + '"' : "") };
                },
                d = function e(t) {
                ...
                w = function (e) {
                    for (var t = [], r = 0; r < e.length; r++) {
                        var n = o({}, y(e[r]), { label: e[r].textContent });
                        t.push(n);
                    }
                    return t;
                },
                    ...
                    (u.register = function (e, t) {
                        ...
                        for (o = a ? o : o[Symbol.iterator](); ; ) {
                            ...
                            if (!e[c]) {
                                ...
                                (d = f.datatype ? f.datatype : c + "-" + Math.floor(9e3 * Math.random() + 1e3)), (u.customRegister[d] = jQuery.extend(f, { type: c, class: p }));
                            }
            ...
            var l = (function (t) {
                ...
                return (
                    (f.build = function () {
                        ...
                        return f.push(this.markup("ul", c, { id: o.id + "-list", className: "formbuilder-" + n + "-list" })), f;
                    }),
            ...
            var d = (function (e) {
                ...
                return (
                    ...
                    (n.prototype.build = function () {
                        ...
                        return o[t] && (n = o[t]), { field: this.markup(n, c.f.parsedHtml(this.label), r), layout: "noLabel" };
                    }),
                    n
                );
            })(o.a);
                ...
                return (
                    (u.build = function () {
                        ...
                        if (((u.multiple || "checkbox-group" === i) && (u.name = u.name + "[]"), "checkbox-group" === i && u.required && (this.onRender = this.groupRequired), delete u.title, r)) {
                            o && c && e.push(this.markup("option", o, { disabled: null, selected: null }));
                            ...
                            if (!c && l) {
                                var j,
                                    q = { id: u.id + "-other", className: u.className + " other-option", value: "" },
                                    C = "formbuilder-" + f;
                                ...
                                var E = {
                                    ...
                                    S = this.markup("label", N, { for: j.id }),
                                    T = this.markup("div", [L, S], { className: C });
                                e.push(T);
                            }
                        }
                        return (this.dom = "select" == i ? this.markup(f, e, u) : this.markup("div", e, { className: i })), this.dom;
                    }),
                ...
                return (
                    (o.configure = function () {
                        var e = { modules: { toolbar: [[{ header: [1, 2, !1] }], ["bold", "italic", "underline"], ["code-block"]] }, placeholder: this.config.placeholder || "", theme: "snow" },
                            ...
                            r = t[0],
                            n = t[1];
                        Object.assign(this, O({}, { js: "//cdn.quilljs.com/1.2.4/quill.js", css: "//cdn.quilljs.com/1.2.4/quill.snow.css" }, r)), (this.editorConfig = O({}, e, n));
                    }),
                    (o.build = function () {
                        var e = this.config,
                            t =
        ...
        function (e, t, r) {
            ...
            e.exports = function (e, t, r) {
                ...
                return o(r) && ((a = "leading" in r ? !!r.leading : a), (l = "trailing" in r ? !!r.trailing : l)), n(e, t, { leading: a, maxWait: t, trailing: l });
            };
        },
        function (e, t, r) {
            var n = r(17);
        ...
        function (e, t, r) {
            ...
            e.exports = function (e, t, r) {
                ...
                return (
                    (t = i(t) || 0),
                    n(r) && ((h = !!r.leading), (c = (g = "maxWait" in r) ? l(i(r.maxWait) || 0, t) : c), (v = "trailing" in r ? !!r.trailing : v)),
                    (O.cancel = function () {
        ...
        function (t, r, n) {
                    ...
                    return (
                        ...
                        (r.updatePreview = function (t) {
                            ...
                            if (!n.includes("input-control")) {
                                ...
                                i.match(r.optionFieldsRegEx) &&
                                    ...
                                    ((s = Object(p.z)(s)).className = this.classNames(o, s)),
                                    t.data("fieldData", s);
                        ...
                        (r.closeConfirm = function (e, t) {
                            e || (e = document.getElementsByClassName("form-builder-overlay")[0]),
                                ...
                                document.dispatchEvent(c.a.modalClosed);
                        }),
                        ...
                        (r.confirm = function (e, t, r, n) {
                            ...
                            var c = Object(p.p)("div", [e, u], { className: n });
                            if (r) c.classList.add("positioned");
                            else {
                                var d = document.documentElement;
                                (r = { pageX: Math.max(d.clientWidth, window.innerWidth || 0) / 2, pageY: Math.max(d.clientHeight, window.innerHeight || 0) / 2 }), (c.style.position = "fixed");
                            }
                        ...
                        (r.dialog = function (e, t, r) {
                            ...
                            return (
                                ...
                                document.dispatchEvent(c.a.modalOpened),
                                -1 !== r.indexOf("data-dialog") && document.dispatchEvent(c.a.viewData),
                                i
                            );
                        }),
                        ...
                        (r.toggleEdit = function (t, r) {
                            ...
                            return (
                                ...
                                n.classList.contains("editing")
                                    ? ((this.formBuilder.currentEditPanel = o[0]), m.a.opts.onOpenFieldEdit(o[0]), document.dispatchEvent(c.a.fieldEditOpened))
                                    : (m.a.opts.onCloseFieldEdit(o[0]), document.dispatchEvent(c.a.fieldEditClosed)),
                                n
                            );
                        }),
                        ...
                        (r.stickyControls = function () {
                            ...
                            e(window).scroll(function (t) {
                                ...
                                if (l > a) {
                                    var f = Object.assign({ position: "sticky" }, u),
                                        c = r.getBoundingClientRect(),
                                        d = n.getBoundingClientRect(),
                                        p = c.top + c.height,
                                        b = d.top + d.height,
                                        h = p === b && c.top > l;
                                    p > b && c.top !== d.top && o.css({ position: "absolute", top: "auto", bottom: 0, right: 0, left: "auto" }), (p < b || h) && o.css(f);
                        ...
                        (r.removeField = function (t, r) {
                            ...
                            return d && d.onremove && d.onremove(l), document.dispatchEvent(c.a.fieldRemoved), n;
                        }),
                        ...
                        return (
                            ...
                            (t.setupControls = function () {
                                ...
                                for (var o = 0; o < r.length; o++) {
                                    ...
                                    var c = Object(p.p)("li", Object(p.p)("span", u), { className: f + " input-control input-control-" + o });
            ...
            var A = function (e, t, r) {
                    ...
                    var g = new e.layout(e.layoutTemplates, !0),
                        A = new v(u, g, o),
                        O = p.p;
                    (e = A.processOptions(e)), (b.layout = A.editorLayout(e.controlPosition)), A.editorUI(u), (b.formID = u), (b.lastID = b.formID + "-fld-0");
                    var k = new y(e, h),
                    ...
                    var E = function (t) {
                        ...
                        L = r(h.editorWrap),
                        N = O("div", h.controls, { id: b.formID + "-cb-wrap", className: "cb-wrap " + b.layout.controls });
                    e.showActionButtons && N.appendChild(h.formActions),
                        L.append(h.stage, N),
                    ...
                    var S = function (t, n) {
                        ...
                        T = function (t) {
                            ...
                            (t = A.getData(t)) && t.length
                                ...
                                ? (e.defaultFields.forEach(function (e) {
                                  ...
                                  h.stage.classList.remove("empty"))
                                : e.prepend || e.append || (h.stage.classList.add("empty"), (h.stage.dataset.content = f.a.get("getStarted"))),
                                (n = []),
                                (o = function (t) {
                                    return O("li", e[t], { className: "disabled-field form-" + t });
                                }),
                                e.prepend && !r(".disabled-field.form-prepend", h.stage).length && (n.push(!0), q.prepend(o("prepend"))),
                                e.append && !r(".disabled-field.form-.append", h.stage).length && (n.push(!0), q.append(o("append"))),
                                A.disabledTT(h.stage),
                                n.some(function (e) {
                                    return !0 === e;
                                }) && h.stage.classList.remove("empty"),
                                A.save();
                        ...
                        D = function (e) {
                            var t,
                                ...
                                n = e.values,
                                o = e.name,
                                i = [O("a", f.a.get("addOption"), { className: "add add-opt" })],
                                a = [O("label", f.a.get("selectOptions"), { className: "false-label" })],
                            ...
                            if (n && n.length)
                                ...
                                var u = (t = s.map(function (e) {
                                    return (t = "" + f.a.get("optionCount", e)), (n = { label: t, value: Object(p.m)(t) }), "autocomplete" !== r && (n.selected = !1), n;
                                    var t, n;
                                }))[0];
                                u.hasOwnProperty("selected") && "radio-group" !== r && (u.selected = !0);
                            }
                            var c = O("div", i, { className: "option-actions" }),
                                d = O(
                                    "ol",
                                    t.map(function (e) {
                                        return Y(o, e, l);
                                ...
                                m = O("div", [d, c], { className: "sortable-options-wrap" });
                            return a.push(m), O("div", a, { className: "form-group field-options" }).outerHTML;
                        },
                        B = function (t) {
                            var r,
                                n = t.type,
                                ...
                                a = {
                                    ...
                                    toggle: function () {
                                        return I("toggle", t, { first: f.a.get("toggle") });
                                    },
                                    inline: function () {
                                        var e = { first: f.a.get("inline"), second: f.a.get("inlineDesc", n.replace("-group", "")) };
                                        return I("inline", t, e);
                                    },
                                    label: function () {
                                        return H("label", t);
                                    ...
                                    access: function () {
                                        ...
                                        n.push("</div>");
                                        var a = { first: f.a.get("roles"), second: f.a.get("limitRole"), content: n.join("") };
                                        return I("access", t, a);
                                    },
                                    other: function () {
                                        return I("other", t, { first: f.a.get("enableOther"), second: f.a.get("enableOtherMsg") });
                                    },
                                    options: function () {
                                        return D(t);
                                    },
                                    requireValidOption: function () {
                                        return I("requireValidOption", t, { first: " ", second: f.a.get("requireValidOption") });
                                    },
                                    multiple: function () {
                                        var e = {
                                            default: { first: "Multiple", second: "set multiple attribute" },
                                            file: { first: f.a.get("multipleFiles"), second: f.a.get("allowMultipleFiles") },
                                            select: { first: " ", second: f.a.get("selectionsMessage") },
                                        };
                    ...
                    var I = function (e, t, r) {
                            void 0 === r && (r = {});
                            var n = function (t) {
                                    return O("label", t, { for: e + "-" + b.lastID }).outerHTML;
                                },
                            ...
                            return (
                                ...
                                (a = O("div", a, { className: "input-wrap" }).outerHTML),
                                O("div", i.concat(a), { className: "form-group " + e + "-wrap" }).outerHTML
                            );
                        },
                        z = function (e) {
                            var t = "";
                            ...
                            return (
                                ...
                                m.d.btn.forEach(function (r) {
                                    ...
                                    e === r && n.push("selected");
                                    var o = O("button", f.a.get("styles.btn." + r), { value: r, type: "button", className: n.join(" ") }).outerHTML;
                                    t += o;
                                }),
                                (t = O("div", [r, (t += "</div>")], { className: "form-group style-wrap" })).outerHTML
                            );
                        },
                        P = function (e, t) {
                            var r = t.class,
                                ...
                                a = f.a.get(e) || e,
                                l = { type: "number", value: i, name: e, placeholder: f.a.get("placeholder." + e), className: ("fld-" + e + " form-control " + (r || n || "")).trim(), id: e + "-" + b.lastID },
                                s = A.input(Object(p.z)(l)).outerHTML;
                            return O("div", ['<label for="' + l.id + '">' + a + "</label>", '<div class="input-wrap">' + s + "</div>"], { className: "form-group " + e + "-wrap" }).outerHTML;
                        },
                        U = function (e, t, r) {
                            var n = r.map(function (r, n) {
                                    var o = Object.assign({ label: l.option + " " + n, value: void 0 }, r);
                                    return r.value === t[e] && (o.selected = !0), (o = Object(p.z)(o)), O("option", o.label, o);
                                }),
                                o = { id: e + "-" + b.lastID, name: e, className: "fld-" + e + " form-control" },
                                i = f.a.get(e) || Object(p.d)(e) || "",
                                a = O("label", i, { for: o.id }),
                                s = O("select", n, o),
                                u = O("div", s, { className: "input-wrap" });
                            return O("div", [a, u], { className: "form-group " + o.name + "-wrap" }).outerHTML;
                        },
                        H = function (t, r, n) {
                            void 0 === n && (n = !1);
                            var o = r[t] || "",
                            ...
                            if (
                                ...
                                var s = { name: t, placeholder: a, className: "fld-" + t + " form-control", id: t + "-" + b.lastID },
                                    u = O("label", i, { for: s.id }).outerHTML;
                                ...
                                var c = '<div class="input-wrap">' + l + "</div>",
                                    d = n ? "none" : "block";
                                "value" === t && (d = r.subtype && "quill" === r.subtype && "none"), (l = O("div", [u, c], { className: "form-group " + t + "-wrap", style: "display: " + d }));
                            }
                            return l.outerHTML;
                        },
                        Q = function (e) {
                            ...
                            return (
                                ...
                                r.some(function (e) {
                                    return !0 === e;
                                }) || (n = I("required", e, { first: f.a.get("required") })),
                                n
                            );
                        },
                        V = function (t, n) {
                            void 0 === n && (n = !0), (b.lastID = A.incrementId(b.lastID));
                            var i = t.type || "text",
                                a = t.label || (n ? l.get(i) || f.a.get("label") : ""),
                                s = e.disabledFieldButtons[i] || t.disabledFieldButtons,
                                u = [
                                    O("a", null, { type: "remove", id: "del_" + b.lastID, className: "del-button btn icon-cancel delete-confirm", title: f.a.get("removeMessage") }),
                                    O("a", null, { type: "edit", id: b.lastID + "-edit", className: "toggle-form btn icon-pencil", title: f.a.get("hide") }),
                                    O("a", null, { type: "copy", id: b.lastID + "-copy", className: "copy-button btn icon-copy", title: f.a.get("copyButtonTooltip") }),
                                ];
                            s &&
                                Array.isArray(s) &&
                            ...
                            var c = [O("div", u, { className: "field-actions" })];
                            c.push(O("label", Object(p.t)(a), { className: "field-label" })), c.push(O("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));
                            var d = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };
                            c.push(O("span", "?", d)), c.push(O("div", "", { className: "prev-holder" }));
                            var m = O("div", [B(t), O("a", f.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                                g = O("div", m, { id: b.lastID + "-holder", className: "frm-holder", dataFieldId: b.lastID });
                            (o.currentEditPanel = g), c.push(g);
                            var v = O("li", c, { class: i + "-field form-field", type: i, id: b.lastID }),
                                y = r(v);
                            y.data("fieldData", { attrs: t }),
                                void 0 !== A.stopIndex ? r("> li", h.stage).eq(A.stopIndex).before(y) : q.append(y),
                                ...
                                n && (e.editOnAdd && (A.closeAllEdit(), A.toggleEdit(b.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({ behavior: "smooth" }));
                        },
                        Y = function (e, t, r) {
                            ...
                            var u = { className: "remove btn icon-cancel", title: f.a.get("removeMessage") };
                        ...
                        q.on("click touchstart", ".remove", function (t) {
                            ...
                            t.preventDefault(),
                                o.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox")
                                    ? e.notify.error("Error: " + f.a.get("minOptionMessage"))
                    ...
                    if (
                        (q.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), function (e) {
                            var t;
                    ...
                    return (
                        document.dispatchEvent(c.a.loaded),
                        (o.actions = {
                            ...
                            setLang: function (e) {
                                f.a.setCurrent.call(f.a, e).then(function () {
                                    (h.stage.dataset.content = f.a.get("getStarted")),
                                        k.init(),
                                        h.empty(h.formActions),
                                        A.formActionButtons().forEach(function (e) {
